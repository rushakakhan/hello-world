...
class Selenium::WebDriver::Edge::Options
  ...
  def in_private; end
  def in_private=(_); end
  def start_page; end
  def start_page=(_); end
end
...
class Selenium::WebDriver::Firefox::Profile
  ...
  def encoded; end
  def layout_on_disk; end
  def load_no_focus_lib=(_); end
  def load_no_focus_lib?; end
  def log_file; end
  def log_file=(file); end
  def name; end
  def native_events=(_); end
  def native_events?; end
  def port=(port); end
  def proxy=(proxy); end
  def secure_ssl=(_); end
  def secure_ssl?; end
...
module Selenium::WebDriver::PointerActions
  ...
  def default_move_duration=(_); end
...
class Selenium::WebDriver::Safari::Options
  ...
  def automatic_inspection=(_); end
  def automatic_profiling; end
  def automatic_profiling=(_); end
end
