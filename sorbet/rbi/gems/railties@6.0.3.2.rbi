...
class Rails::Application < ::Rails::Engine
  ...
  def console(&blk); end
  def credentials; end
  def default_url_options(*_, &_); end
...
class Rails::Application::RoutesReloader
  ...
  def eager_load=(_); end
  def execute(*_, &_); end
  def execute_if_updated(*_, &_); end
  def paths; end
  def reload!; end
  def route_sets; end
  def updated?(*_, &_); end
...
class Rails::Engine < ::Rails::Railtie
  ...
  def eager_load!; end
  def endpoint; end
  def engine_name(*_, &_); end
  def env_config; end
  def helpers; end
  def helpers_paths; end
  def isolated?(*_, &_); end
  def load_console(app = T.unsafe(nil)); end
  def load_generators(app = T.unsafe(nil)); end
  def load_runner(app = T.unsafe(nil)); end
  def load_seed; end
  def load_tasks(app = T.unsafe(nil)); end
  def middleware(*_, &_); end
  def paths(*_, &_); end
  def railties; end
  def root(*_, &_); end
