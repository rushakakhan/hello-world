...
class GraphQL::Pagination::Connection
  def initialize(items, parent: T.unsafe(nil), context: T.unsafe(nil), first: T.unsafe(nil), after: T.unsafe(nil), max_page_size: T.unsafe(nil), last: T.unsafe(nil), before: T.unsafe(nil)); end
...
module GraphQL::Schema::BuildFromDefinition
  class << self
    def from_definition(definition_string, default_resolve:, using: T.unsafe(nil), relay: T.unsafe(nil), interpreter: T.unsafe(nil), parser: T.unsafe(nil)); end
  end
end
