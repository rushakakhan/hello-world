...
module Capybara::DSL
  def accept_alert(*_, &_); end
  def accept_confirm(*_, &_); end
  def accept_prompt(*_, &_); end
  def all(*_, &_); end
  def assert_all_of_selectors(*_, &_); end
  def assert_any_of_selectors(*_, &_); end
  def assert_current_path(*_, &_); end
  def assert_no_current_path(*_, &_); end
  def assert_no_selector(*_, &_); end
  def assert_no_text(*_, &_); end
  def assert_no_title(*_, &_); end
  def assert_none_of_selectors(*_, &_); end
  def assert_selector(*_, &_); end
  def assert_text(*_, &_); end
  def assert_title(*_, &_); end
  def attach_file(*_, &_); end
  def body(*_, &_); end
  def check(*_, &_); end
  def choose(*_, &_); end
  def click_button(*_, &_); end
  def click_link(*_, &_); end
  def click_link_or_button(*_, &_); end
  def click_on(*_, &_); end
  def current_host(*_, &_); end
  def current_path(*_, &_); end
  def current_scope(*_, &_); end
  def current_url(*_, &_); end
  def current_window(*_, &_); end
  def dismiss_confirm(*_, &_); end
  def dismiss_prompt(*_, &_); end
  def evaluate_script(*_, &_); end
  def execute_script(*_, &_); end
  def fill_in(*_, &_); end
  def find(*_, &_); end
  def find_all(*_, &_); end
  def find_button(*_, &_); end
  def find_by_id(*_, &_); end
  def find_field(*_, &_); end
  def find_link(*_, &_); end
  def first(*_, &_); end
  def go_back(*_, &_); end
  def go_forward(*_, &_); end
  def has_button?(*_, &_); end
  def has_checked_field?(*_, &_); end
  def has_content?(*_, &_); end
  def has_css?(*_, &_); end
  def has_current_path?(*_, &_); end
  def has_field?(*_, &_); end
  def has_link?(*_, &_); end
  def has_no_button?(*_, &_); end
  def has_no_checked_field?(*_, &_); end
  def has_no_content?(*_, &_); end
  def has_no_css?(*_, &_); end
  def has_no_current_path?(*_, &_); end
  def has_no_field?(*_, &_); end
  def has_no_link?(*_, &_); end
  def has_no_select?(*_, &_); end
  def has_no_selector?(*_, &_); end
  def has_no_table?(*_, &_); end
  def has_no_text?(*_, &_); end
  def has_no_title?(*_, &_); end
  def has_no_unchecked_field?(*_, &_); end
  def has_no_xpath?(*_, &_); end
  def has_select?(*_, &_); end
  def has_selector?(*_, &_); end
  def has_table?(*_, &_); end
  def has_text?(*_, &_); end
  def has_title?(*_, &_); end
  def has_unchecked_field?(*_, &_); end
  def has_xpath?(*_, &_); end
  def html(*_, &_); end
  def open_new_window(*_, &_); end
  def page; end
  def query(*_, &_); end
  def refresh(*_, &_); end
  def refute_selector(*_, &_); end
  def reset_session!(*_, &_); end
  def response_headers(*_, &_); end
  def save_and_open_page(*_, &_); end
  def save_and_open_screenshot(*_, &_); end
  def save_page(*_, &_); end
  def save_screenshot(*_, &_); end
  def scroll_by(*_, &_); end
  def scroll_to(*_, &_); end
  def select(*_, &_); end
  def source(*_, &_); end
  def status_code(*_, &_); end
  def switch_to_frame(*_, &_); end
  def switch_to_window(*_, &_); end
  def text(*_, &_); end
  def title(*_, &_); end
  def uncheck(*_, &_); end
  def unselect(*_, &_); end
  def using_session(name_or_session, &block); end
  def using_wait_time(seconds, &block); end
  def visit(*_, &_); end
  def window_opened_by(*_, &_); end
  def windows(*_, &_); end
  def within(*_, &_); end
  def within_element(*_, &_); end
  def within_fieldset(*_, &_); end
  def within_frame(*_, &_); end
  def within_table(*_, &_); end
  def within_window(*_, &_); end
...
class Capybara::RackTest::Node < ::Capybara::Driver::Node
  def ==(other); end
  def [](*_, &_); end
  def all_text(*_, &_); end
  def checked?(*_, &_); end
  def click(*_, &_); end
  def disabled?(*_, &_); end
  def find_css(*_, &_); end
  def find_xpath(*_, &_); end
  def path(*_, &_); end
  def select_option(*_, &_); end
  def selected?(*_, &_); end
  def set(*_, &_); end
  def style(*_, &_); end
  def tag_name(*_, &_); end
  def unselect_option(*_, &_); end
  def value(*_, &_); end
  def visible?(*_, &_); end
  def visible_text(*_, &_); end
