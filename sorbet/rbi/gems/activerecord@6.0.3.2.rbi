...
class ActiveRecord::Associations::CollectionProxy < ::ActiveRecord::Relation
  ...
  def ==(other); end
  def _select!(*_, &_); end
  def annotate(*_, &_); end
  def annotate!(*_, &_); end
  def annotate_values(*_, &_); end
  ...
  def clear; end
  def concat(*records); end
  def construct_join_dependency(*_, &_); end
  def create(attributes = T.unsafe(nil), &block); end
  def create!(attributes = T.unsafe(nil), &block); end
  def create_with(*_, &_); end
  def create_with!(*_, &_); end
  def create_with_value(*_, &_); end
  def create_with_value=(arg); end
  def delete(*records); end
  def delete_all(dependent = T.unsafe(nil)); end
  def destroy(*records); end
  def destroy_all; end
  def distinct(*_, &_); end
  def distinct!(*_, &_); end
  def distinct_value(*_, &_); end
  def distinct_value=(arg); end
  def eager_load(*_, &_); end
  def eager_load!(*_, &_); end
  def eager_load_values(*_, &_); end
  def eager_load_values=(arg); end
  def empty?; end
  def except(*_, &_); end
  def extending(*_, &_); end
  def extending!(*_, &_); end
  def extending_values(*_, &_); end
  def extending_values=(arg); end
  def extensions(*_, &_); end
  def extract_associated(*_, &_); end
  def find(*args); end
  def from(*_, &_); end
  def from!(*_, &_); end
  def from_clause(*_, &_); end
  def from_clause=(arg); end
  def group(*_, &_); end
  def group!(*_, &_); end
  def group_values(*_, &_); end
  def group_values=(arg); end
  def having(*_, &_); end
  def having!(*_, &_); end
  def having_clause(*_, &_); end
  def having_clause=(arg); end
  def include?(record); end
  def includes(*_, &_); end
  def includes!(*_, &_); end
  def includes_values(*_, &_); end
  def includes_values=(arg); end
  def joins(*_, &_); end
  def joins!(*_, &_); end
  def joins_values(*_, &_); end
  def joins_values=(arg); end
  def last(limit = T.unsafe(nil)); end
  def left_joins(*_, &_); end
  def left_outer_joins(*_, &_); end
  def left_outer_joins!(*_, &_); end
  def left_outer_joins_values(*_, &_); end
  def left_outer_joins_values=(arg); end
  def limit(*_, &_); end
  def limit!(*_, &_); end
  def limit_value(*_, &_); end
  def limit_value=(arg); end
  def load_target; end
  def loaded?; end
  def lock(*_, &_); end
  def lock!(*_, &_); end
  def lock_value(*_, &_); end
  ...
  def offset(*_, &_); end
  def offset!(*_, &_); end
  def offset_value(*_, &_); end
  def offset_value=(arg); end
  def only(*_, &_); end
  def optimizer_hints(*_, &_); end
  def optimizer_hints!(*_, &_); end
  def optimizer_hints_values(*_, &_); end
  def optimizer_hints_values=(arg); end
  def or(*_, &_); end
  def or!(*_, &_); end
  def order(*_, &_); end
  def order!(*_, &_); end
  def order_values(*_, &_); end
  def order_values=(arg); end
  def pluck(*column_names); end
  def preload(*_, &_); end
  def preload!(*_, &_); end
  def preload_values(*_, &_); end
  def preload_values=(arg); end
  def prepend(*args); end
  def proxy_association; end
  def push(*records); end
  def readonly(*_, &_); end
  def readonly!(*_, &_); end
  def readonly_value(*_, &_); end
  def readonly_value=(arg); end
  def records; end
  def references(*_, &_); end
  def references!(*_, &_); end
  def references_values(*_, &_); end
  def references_values=(arg); end
  def reload; end
  def reorder(*_, &_); end
  def reorder!(*_, &_); end
  def reordering_value(*_, &_); end
  def reordering_value=(arg); end
  def replace(other_array); end
  def reselect(*_, &_); end
  def reselect!(*_, &_); end
  def reset; end
  def reset_scope; end
  def reverse_order(*_, &_); end
  def reverse_order!(*_, &_); end
  def reverse_order_value(*_, &_); end
  def reverse_order_value=(arg); end
  def rewhere(*_, &_); end
  def scope; end
  def scoping(*_, &_); end
  def select_values(*_, &_); end
  def select_values=(arg); end
  def size; end
  def skip_preloading!(*_, &_); end
  def skip_query_cache!(*_, &_); end
  def skip_query_cache_value(*_, &_); end
  ...
  def unscope(*_, &_); end
  def unscope!(*_, &_); end
  def unscope_values(*_, &_); end
  def unscope_values=(arg); end
  def values(*_, &_); end
  def where(*_, &_); end
  def where!(*_, &_); end
  def where_clause(*_, &_); end
...
class ActiveRecord::Base
  ...
  def collection_cache_versioning?; end
  def column_for_attribute(*_, &_); end
  ...
  def type_for_attribute(*_, &_); end
...
class ActiveRecord::ConnectionAdapters::AbstractAdapter::SchemaCreation
  ...
  def foreign_key_options(*_, &_); end
  def options_include_default?(*_, &_); end
  def quote_column_name(*_, &_); end
  def quote_default_expression(*_, &_); end
  def quote_table_name(*_, &_); end
  def supports_foreign_keys?(*_, &_); end
  def supports_indexes_in_create?(*_, &_); end
  def table_modifier_in_create(o); end
  def table_options(o); end
  def to_sql(sql); end
  def type_to_sql(*_, &_); end
...
module ActiveRecord::ConnectionAdapters::DatabaseStatements
  ...
  def begin_transaction(*_, &_); end
  def cacheable_query(klass, arel); end
  def commit_db_transaction; end
  def commit_transaction(*_, &_); end
  ...
  def materialize_transactions(*_, &_); end
  def open_transactions(*_, &_); end
  ...
  def rollback_transaction(*_, &_); end
  ...
  def within_new_transaction(*_, &_); end
...
class ActiveRecord::InsertAll::Builder
  ...
  def model; end
  def returning; end
  def skip_duplicates?(*_, &_); end
  def updatable_columns; end
  def update_duplicates?(*_, &_); end
  def values_list; end
...
class ActiveRecord::PredicateBuilder
  ...
  def resolve_column_aliases(*_, &_); end
...
module ActiveRecord::Querying
  ...
  def any?(*_, &_); end
  def average(*_, &_); end
  def calculate(*_, &_); end
  def count(*_, &_); end
  def count_by_sql(sql); end
  def create_or_find_by(*_, &_); end
  def create_or_find_by!(*_, &_); end
  def create_with(*_, &_); end
  def delete_all(*_, &_); end
  def delete_by(*_, &_); end
  def destroy_all(*_, &_); end
  def destroy_by(*_, &_); end
  def distinct(*_, &_); end
  def eager_load(*_, &_); end
  def except(*_, &_); end
  def exists?(*_, &_); end
  ...
  def find_each(*_, &_); end
  def find_in_batches(*_, &_); end
  def find_or_create_by(*_, &_); end
  def find_or_create_by!(*_, &_); end
  def find_or_initialize_by(*_, &_); end
  def first(*_, &_); end
  def first!(*_, &_); end
  def first_or_create(*_, &_); end
  def first_or_create!(*_, &_); end
  def first_or_initialize(*_, &_); end
  def forty_two(*_, &_); end
  def forty_two!(*_, &_); end
  def fourth(*_, &_); end
  def fourth!(*_, &_); end
  def from(*_, &_); end
  ...
  def third(*_, &_); end
  def third!(*_, &_); end
  def third_to_last(*_, &_); end
  def third_to_last!(*_, &_); end
  def touch_all(*_, &_); end
  def unscope(*_, &_); end
  def update_all(*_, &_); end
  def where(*_, &_); end
end
...
class ActiveRecord::Reflection::PolymorphicReflection < ::ActiveRecord::Reflection::AbstractReflection
  ...
  def constraints; end
  def get_join_keys(*_, &_); end
  def join_scopes(table, predicate_builder); end
  def klass(*_, &_); end
  def plural_name(*_, &_); end
  def scope(*_, &_); end
  def scope_for(*_, &_); end
  def type(*_, &_); end
...
class ActiveRecord::Reflection::ThroughReflection < ::ActiveRecord::Reflection::AbstractReflection
  ...
  def active_record(*_, &_); end
  def active_record_primary_key(*_, &_); end
  def add_as_polymorphic_through(reflection, seed); end
  def add_as_source(seed); end
  def add_as_through(seed); end
  def association_class(*_, &_); end
  def association_foreign_key(*_, &_); end
  def association_primary_key(klass = T.unsafe(nil)); end
  def association_scope_cache(*_, &_); end
  def autosave=(arg); end
  def belongs_to?(*_, &_); end
  def check_eager_loadable!(*_, &_); end
  def check_preloadable!(*_, &_); end
  def check_validity!; end
  def clear_association_scope_cache; end
  def collect_join_chain; end
  def collection?(*_, &_); end
  def compute_class(*_, &_); end
  def constraints; end
  def constructable?(*_, &_); end
  def extensions(*_, &_); end
  def foreign_key(*_, &_); end
  def foreign_type(*_, &_); end
  def get_join_keys(*_, &_); end
  def has_inverse?(*_, &_); end
  def has_one?(*_, &_); end
  def has_scope?; end
  def join_id_for(*_, &_); end
  def join_scopes(table, predicate_builder); end
  def join_table(*_, &_); end
  def klass; end
  def macro(*_, &_); end
  def name(*_, &_); end
  def nested?; end
  def options(*_, &_); end
  def parent_reflection(*_, &_); end
  def parent_reflection=(arg); end
  def plural_name(*_, &_); end
  def polymorphic?(*_, &_); end
  def polymorphic_inverse_of(*_, &_); end
  def scope(*_, &_); end
  def scope_for(*_, &_); end
  def scopes; end
...
class ActiveRecord::TableMetadata
  ...
  def association_foreign_key(*_, &_); end
  def association_foreign_type(*_, &_); end
  def association_join_foreign_key(*_, &_); end
  def association_join_primary_key(*_, &_); end
...
class ActiveRecord::Tasks::MySQLDatabaseTasks
  ...
  def create; end
  def drop; end
  def establish_connection(*_, &_); end
  def purge; end
