...
class Avro::AvroError < ::StandardError
end
...
class Avro::DataFile::DataFileError < ::Avro::AvroError
end
...
class Avro::IPC::AvroRemoteError < ::Avro::AvroError
end

class Avro::IPC::AvroRemoteException < ::Avro::AvroError
end
...
class Avro::IPC::ConnectionClosedError < ::StandardError
end

class Avro::IPC::ConnectionClosedException < ::Avro::AvroError
end
...
class Avro::Protocol::ProtocolParseError < ::Avro::AvroError
end
...
class Avro::SchemaParseError < ::Avro::AvroError
end
...
class Avro::SchemaValidator
  class << self
    ...
    def validate_array(expected_schema, datum, path, result, options = T.unsafe(nil)); end
    def validate_map(expected_schema, datum, path, result, options = T.unsafe(nil)); end
    def validate_recursive(expected_schema, logical_datum, path, result, options = T.unsafe(nil)); end
    def validate_simple(expected_schema, logical_datum, path, result, options = T.unsafe(nil)); end
    def validate_type(expected_schema); end
    def validate_union(expected_schema, datum, path, result, options = T.unsafe(nil)); end
  end
end
...
class Avro::SchemaValidator::TypeMismatchError < ::Avro::SchemaValidator::ValidationError
end
